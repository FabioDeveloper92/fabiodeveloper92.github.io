...
const it = {
  ...
  'hero.description': 'Costruisco soluzioni digitali su misura, che danno slancio alle tue idee.',
  ...
  'about.current': 'Attualmente lavoro in Mind3, dove mi occupo di turismo B2B, sviluppando soluzioni web innovative su misura per agenzie di viaggio, con l\'obiettivo di facilitare e migliorare l\'esperienza delle persone.',
  'about.goal': 'Il mio obiettivo è creare soluzioni digitali all\'avanguardia che uniscano tecnologia e creatività, per aiutare aziende e persone a trasformare le loro idee in realtà tangibili, migliorando l\'esperienza digitale e generando valore concreto.',
