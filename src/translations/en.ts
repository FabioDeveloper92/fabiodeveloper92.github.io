...
const en = {
  ...
  "hero.description":
    "I build tailor-made digital solutions that give momentum to your ideas.",
  ...
  "about.intro":
    "I'm a Software Developer with a passion for creating robust and elegant digital solutions. With several years of experience in web and application development, I dedicate myself to building software that solves real problems.",
  "about.current":
    "I currently work at Mind3, where I focus on B2B travel by developing innovative, tailor-made web solutions for travel agencies, aiming to simplify and enhance people's experiences.",
  "about.goal":
    "My goal is to create cutting-edge digital solutions that combine technology and creativity, helping businesses and individuals turn their ideas into tangible realities, enhancing digital experiences and generating real value.",
  ...
  "contact.description":
    "Do you have an interesting project or want to discuss collaboration opportunities? Send me a message and I will respond as soon as possible.",
  "contact.phone": "Phone",
  ...
  "projects.description":
    "A selection of my best software development projects.",
   "projects.description_row2": "Each project represents unique challenges that I faced and solved with competence and creativity.",
  ...
  "projectsPage.description":
    "Explore the full range of my software development projects.",
  "projectsPage.description_row2":
    "Each project represents a unique challenge I faced, applying creativity, technical expertise, and strategic thinking.",
  "projectsPage.backHome": "Back to home",

  // Project detail page
  "projectDetail.notFound": "Project not found",
  "projectDetail.notFoundDesc":
